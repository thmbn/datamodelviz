# Open-source relational data model visualization — landscape

> Snapshot taken 2026-05-27. Star counts are rough and will drift.
...
## What this means for datamodelviz

- **Crowded center**: DrawDB + ChartDB own the "free, browser-based, AGPL editor" niche. Competing there means UX polish or a sharp wedge.
- **Under-served edges**:
  1. **Large-schema navigation** (only Azimutt + Liam really address)
  2. **Round-tripping ERD ↔ migrations ↔ ORM** (only [quick-erd](https://github.com/beenotung/quick-erd) attempts it)
  3. **Embeddable components** vs. full apps (everyone reinvents on React Flow)
- **If web app**: substrate is almost certainly **React Flow/xyflow**, and you'll want **DBML** import/export for ecosystem interop.
